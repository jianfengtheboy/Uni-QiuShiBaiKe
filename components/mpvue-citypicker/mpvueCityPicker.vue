 ...
 * @Date: 2020-04-05 22:18:56
 * @LastEditTime: 2020-04-05 23:00:35
 * @Description: mpvueCityPicker
 -->
<template>
  <div class="mpvue-picker">
    <div :class="{'pickerMask' : showPicker}"
          @click="maskClick"
          catchtouchmove="true">
    </div>
    <div class="mpvue-picker-content"
      ...
      <div class="mpvue-picker__hd" catchtouchmove="true">
        ...
        <div class="mpvue-picker__action"
              :style="{color : themeColor}"
              @click="pickerConfirm">确定
        </div>
      </div>
